...
We can easily make a word or phrase show up in **bold letters** by starting and ending with 2 asterisks or **starting and ending with 2 underscores**.

We can also highlight some *words in italics* by starting and ending with a single underscore or starting *and ending with 1 asterisks*.
